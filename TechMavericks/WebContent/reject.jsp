...
<div class="wrap">
	...
	<h1>Employee Expense management System</h1>
		       ...
		       Rejectdao dao = new Rejectdao();
			   Reject p = dao.selectReject(pid);
			   if(p == null){
				   out.println("Sorry reports are not uploaded yet.");
			   }
			   else{
			  ...
			  DETAILS
			  <table border='0'>
			   <tr><td>Voucher_ID :</td><td><%=p.getViid() %></td></tr>
			   <tr><td>Voucher Report:</td><td><%=p.getNotes()%></td> 
			  </tr>

...
<div class="wrap">
	...
	<h1>Employee Expense management System</h1>
	 ...
	 <table border='0'>
  <tr><td>Employee ID</td><td>vouchertype</td><td>Expense</td><td>Description</td></tr>
  <%

  Voucherdao dao = new Voucherdao();
  List<Voucher> list =  dao.selectVouchers(1); 
   for(Voucher p: list){
  %>
  <tr>
  <td><%out.println("<a href='searchvou.jsp?Vid="+p.getVid()+"'>"+p.getVid()+"</a>");%></td>

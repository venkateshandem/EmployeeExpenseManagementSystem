...
<div class="wrap">
	...
	<div id="content">
		<div id="sidebar">
			...
			<div class="box">
				...
				<ul>
								<li class="b1"><a class="icon users" href="viewvouchersaccount.jsp">View vouchers</a></li>
										</ul>
			</div>
		</div>
		<div id="main">
  ...
  List<Voucher> list =  dao.selectVouchers(2); 
   for(Voucher p: list){
  %>
  <tr>
  <td><%out.println("<a href='searchvouaccnt.jsp?Vid="+p.getVid()+"'>"+p.getVid()+"</a>");%></td>
  <td><%=p.getVid() %></td>
  <td><%=p.getType() %></td>
  <td>
  <%=p.getExp()%></td>
  ...
  <%}} %>
	...
	<div id="footer">
		<div class="left">
			<p> <a href="home.html" target="_blank">Mavericks</a> | Accountant Panel: <a href="#">Expense Management</a></p>
		</div>

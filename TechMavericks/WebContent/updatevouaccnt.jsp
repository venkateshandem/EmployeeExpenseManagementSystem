...
<div class="wrap">
	...
	<div id="content">
		...
		int flag = 3;
		Voucher p = new Voucher(vid,type,exp,desc,flag);
		Voucherdao pDAO = new Voucherdao(); 
		  
if(pDAO.updateVoucher(p)){

	%>
	 <div class="n_ok"><p>Voucher approved Successfully </p></div>
	<%  }

else{%>
	  <div class="n_error"><p>Voucher approval not succesful  </p></div>	

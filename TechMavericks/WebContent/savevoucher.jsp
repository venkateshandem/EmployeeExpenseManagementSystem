			...
			<div class="box">
				...
				<ul>
					<li class="b1"><a class="icon users" href="vouchersubmit.jsp">Submit voucher</a></li>
						...
						<li class="b2"><a class="icon page" href="drafts.jsp">Drafts</a></li>
				</ul>
			</div>
		</div>
		<div id="main">
	...
	<h1>Employee Expense management System</h1>
		...
		<%
			...
			String text1 =  request.getParameter("note");
				 ...
				 Drafts p = new Drafts(vid,typeexpense,expense,text1);
				Draftsdao pDAO = new Draftsdao(); 
				if( pDAO.createDrafts(p)){
				
		%>
<div class="n_ok"><p>Voucher saved Successfully </p></div><%} 
		else{ %>
		<div class="n_error"><p>You already have a draft please go through it in the drafts..  </p> </div><br></br>

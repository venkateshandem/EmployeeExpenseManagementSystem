...
function updatevou(){
	document.form1.action='updatevouaccnt.jsp';
	document.form1.submit();
	
}
function rejectvou(){
	document.form1.action='rejectvouaccnt.jsp';
	document.form1.submit();
...
<%
  ...
  <table border='1'>
   ...
   <tr><td>Voucher Expsense limit</td><td><input type="text" name ="limit" value="<%=q.getLimit()%>" readyonly/></td></tr>
    <tr><td>Description</td><td><input type="text" name ="notes" value="<%=p.getText() %>" readyonly/></td></tr>

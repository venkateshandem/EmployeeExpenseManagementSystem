...
function updateemp(){
	document.form1.action='updatesal1.jsp';
...
function validate()
{
	...
	if((isNaN(limit.value))||salexp.value.length==0)
		{
	...
	<div id="content">
		...
		<div id="main">
			...
			<div class="full_w">
				...
				<h3>Update Employee Salary information</h3>


 <%
 String salaryID= request.getParameter("emp");
 
 %>
 <%
 
 if(salaryID!=null){	Salarydao  dao = new Salarydao();
	Salary p =dao.selectSalary(salaryID);
	 ...
	 <table border='0' cellspacing='0' cellpadding='2'>
	  ...
	  <tr>
	   <td>Salary </td>
	   <td><input type='text' name='sal' value='<%=p.getSal()  %>'/></td>
	  </tr>
	  <tr>
	   <td>Expense limit : </td>
	   <td><input type='text' name='limit' value='<%=p.getLimit()  %>'/></td>
	  </tr>
	  <tr>
